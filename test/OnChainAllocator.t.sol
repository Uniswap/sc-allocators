...
contract OnChainAllocatorTest is Test, TestHelper {
    ...
    //     usdc.mint(address(this), 2 * defaultAmount);
    //     usdc.approve(address(compact), 2 * defaultAmount);
    ...
    //     assertEq(nonce1, _composeNonceUint(recipient, 1));
    //     assertEq(nonce2, _composeNonceUint(address(this), 1));
    ...
    //     // execute for second allocation WHICH SHOULD FAIL BUT IS NOT
    //     vm.prank(address(this));
    //     allocator.executeAllocation(
    //         recipient, idsAndAmountsCrooked, arbiter, defaultExpiration, BATCH_COMPACT_TYPEHASH, bytes32(0), ''
    //     );
